  ...
  return (
    ...
    <div className='my-10 flex flex-col md:flex-row gap-16'>
      ...
      <div className='flex flex-col justify-center gap-6 md:w-2/4 text-black'>
         ...
         <b className='text-red-700'>Nuestra Misión</b>
